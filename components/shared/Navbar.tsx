...
export default function Navbar() {
  ...
  return (
    <header className="w-full py-4 md:py-6 px-4">
      <div className="container mx-auto sticky top-0 z-20">
        <nav className="bg-white rounded-2xl md:rounded-[24px] px-4 md:px-8 py-3 md:py-4 flex items-center justify-between shadow-sm relative">
